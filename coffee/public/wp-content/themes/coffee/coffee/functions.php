...
function coffee_scripts() {
	wp_enqueue_style( 'coffee-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'coffee-style', 'rtl', 'replace' );

	wp_enqueue_script( 'coffee-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
