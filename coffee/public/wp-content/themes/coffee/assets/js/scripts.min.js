...
Fancybox.bind('[data-fancybox="galimage"]', {});
...
bindModal('.contact__btn', '.modal__wrapper', '.modal__close')
bindModal('.modal__form-btn', '.modal__wrapper2', '.modal__close')
...
const inputMask = () => {
  ...
  const btnForm = document.querySelector('.modal__form-btn');
  btnForm.addEventListener('click', (e) => {
    ...
    const model1 = document.querySelector('.modal__wrapper');
    model1.style.display = 'none'

    const model2 = document.querySelector('.modal__wrappe2');
    setTimeout(() => {
  ...
  const inputFeedback = document.querySelectorAll('.modal__form-input');

  inputFeedback.forEach((item) => {
...
const headerLinks = document.querySelectorAll('.menu__item-link');
const burger = document.querySelector('.burger');
...
const skroll = document.querySelector('.skroll__box');

window.addEventListener('scroll', () => {
  const scrollY = window.scrollY || window.pageYOffset;
  if (scrollY > 1600) {
    skroll.classList.add('active');
  } else {
    skroll.classList.remove('active');
  }
});

skroll.addEventListener('click', () => {
  const homeSection = document.getElementById('Home');
  if (homeSection) {
    const top = homeSection.getBoundingClientRect().top + window.scrollY - 100;
    window.scrollTo({ top, behavior: 'smooth' });
  }
});

const footLink = document.querySelectorAll('.footer__link');

footLink.forEach((item) => {
...
const linkNav = document.querySelectorAll('.menu__item');
